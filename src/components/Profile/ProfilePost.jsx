import { Avatar, Box, Divider, Flex, GridItem, Image, Img, Modal, ModalBody, ModalCloseButton, ModalContent, ModalOverlay, Text, VStack, useDisclosure } from "@chakra-ui/react"
      ...
      <Modal isOpen= {isOpen} onClose={onClose} isCentered={true} size={{base:'3xl',md:'5xl'}}>
        ...
        <ModalContent>
          ...
          <ModalBody bg={'black'} pb={5}>
            <Flex gap='4' w={{bas:'90%',sm:'70%',md:'full'}} mx={'auto'}>
              ...
              <Flex flex={1} flexDir={'column'} px={10} display={{base:'none',md:'flex'}}>
                <Flex alignItems={'center'} justifyContent={'space-between'}>
                  <Flex alignItems={'center'} gap={4}>
                    <Avatar src="/profilepic.png" size={'sm'} name="'patoneitor"/>
